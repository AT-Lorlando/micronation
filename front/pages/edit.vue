<template>
  <div class="flex flex-row justify-between">
    ...
    <div
      class="flex flex-col items-center justify-between w-2/6 p-8 mx-4 my-32 border-2 border-blue-400 "
    >
      <div
        class="flex flex-row justify-between w-full border-2 border-red-400 h-1/2 mb-9"
      >
        ...
        <div class="flex flex-col items-center justify-around w-1/2 border-2">
          ...
          <button
            v-on:click="Finish()"
            class="px-4 py-2 text-gray-100 bg-blue-600 rounded-lg"
          >
            Editer le drapeau
          </button>
          <button
